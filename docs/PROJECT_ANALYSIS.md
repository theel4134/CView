...
└──────┬──────┬──────┬──────┬──────┬──────┬──────┬────┘
  ...
  │8,695줄│ │2,071│ │1,290│ │ 648 │ │3,097│ │1,044│ │  1,009   │
  └───┬───┘ └──┬──┘ └──┬──┘ └──┬──┘ └──┬──┘ └─┬──┘ └────┬────┘
      │        │       │       │       │      │         │
  ┌───▼────────▼───────▼───────▼───────▼──────▼─────────▼──┐
  │                  CViewCore (5,976줄)                     │
...
| 파일 | 줄 수 | 역할 |
|------|------|------|
| FollowingView.swift | 2,065 | 팔로잉 메인 뷰 (멀티라이브/채팅 통합) |
| StreamCoordinator.swift | 1,391 | 스트림 재생 오케스트레이터 |
| VLCPlayerEngine.swift | 1,359 | VLC 재생 엔진 |
| MultiLiveSettingsPanel.swift | 1,353 | 멀티라이브 설정 패널 |
| PlayerAdvancedSettingsView.swift | 1,301 | 플레이어 고급 설정 |
| AVPlayerEngine.swift | 1,198 | AVPlayer 재생 엔진 |
| ChatViewModel.swift | 1,147 | 채팅 뷰모델 |
| MultiLiveAddSheet.swift | 994 | 멀티라이브 채널 추가 |
| PlayerViewModel.swift | 971 | 플레이어 뷰모델 |
| DesignTokens.swift | 910 | 디자인 시스템 토큰 |
