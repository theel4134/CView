...
// MARK: - Live Channel Item (View Model)
...
// MARK: - API Client Extension for Home

extension ChzzkAPIClient {

    func fetchFollowingChannels() async throws -> [LiveChannelItem] {
...
private struct LiveChannelAPIResponse: Codable {
