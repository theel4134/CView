        ...
        HStack(spacing: 0) {
            ...
            if manager.sessions.count >= 2 {
                ...
                MLToolButton(
                    ...
                    // 화면 출력이 끊기지 않도록 보장한다.
                    // 비디오 트랙은 항상 활성 상태 유지 (VLC macOS vout 안정성).
                    Task { @MainActor in
...
struct MLTabChip: View {
                    ...
                    Image(systemName: "xmark")
                        ...
                        .background {
                            if isCloseHovered {
                                ...
                                Circle().fill(DesignTokens.Colors.surfaceElevated.opacity(0.5))
                            }
                        }
                }
                .buttonStyle(.plain)
                ...
                RoundedRectangle(cornerRadius: DesignTokens.Radius.md)
                    .strokeBorder(
                        isSelected
                            ...
                            : (isHovered ? DesignTokens.Glass.borderColorLight : Color.clear),
    ...
    private var chipBackground: some View {
        if isSelected {
            ...
            Rectangle().fill(DesignTokens.Colors.surfaceElevated.opacity(0.3))
        } else {
            Color.clear
        }
    }
