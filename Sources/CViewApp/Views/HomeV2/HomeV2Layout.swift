...
struct HomeLayoutMenu: View {
    ...
    @AppStorage("home.v2.show.supersetDock")   private var showAnalyticsDock: Bool = true
    ...
    var body: some View {
        Menu {
            Section("표시 섹션") {
                ...
                Toggle("Analytics Insight Dock", isOn: $showAnalyticsDock)
            }
            Section("카드 밀도") {
